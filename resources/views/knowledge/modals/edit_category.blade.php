    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{ Form::open(['url' => '', 'method' => 'PUT', 'id' => 'edit-category-form']) }}
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Иконка</label><br>
                            {{ Form::hidden('icon_id', null, ['class' => 'input-icon', 'id' => 'category-icon']) }}
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            {{ Form::text('name', null, ['class' => 'form-control', 'required' => true, 'id' => 'category-name']) }}
                        </div>
                    </div>
                </div>
